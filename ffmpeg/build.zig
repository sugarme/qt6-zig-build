...
pub fn build(b: *std.Build) void {
    ...
    const common_config = .{
        ...
        .HAVE_AESNI_EXTERNAL = have_x86_feat(t, .aes) and t.os.tag != .windows,
        .HAVE_AMD3DNOW_EXTERNAL = false,
        .HAVE_AMD3DNOWEXT_EXTERNAL = false,
        .HAVE_AVX_EXTERNAL = have_x86_feat(t, .avx) and t.os.tag != .windows,
        .HAVE_AVX2_EXTERNAL = have_x86_feat(t, .avx2) and t.os.tag != .windows,
        .HAVE_AVX512_EXTERNAL = have_x86_feat(t, .avx512f) and t.os.tag != .windows,
        .HAVE_AVX512ICL_EXTERNAL = have_x86_feat(t, .avx512f) and t.os.tag != .windows,
        .HAVE_FMA3_EXTERNAL = have_x86_feat(t, .fma) and t.os.tag != .windows,
        .HAVE_FMA4_EXTERNAL = have_x86_feat(t, .fma4) and t.os.tag != .windows,
        .HAVE_MMX_EXTERNAL = have_x86_feat(t, .mmx) and t.os.tag != .windows,
        .HAVE_MMXEXT_EXTERNAL = have_x86_feat(t, .mmx) and t.os.tag != .windows,
        .HAVE_SSE_EXTERNAL = have_x86_feat(t, .sse) and t.os.tag != .windows,
        .HAVE_SSE2_EXTERNAL = have_x86_feat(t, .sse2) and t.os.tag != .windows,
        .HAVE_SSE3_EXTERNAL = have_x86_feat(t, .sse3) and t.os.tag != .windows,
        .HAVE_SSE4_EXTERNAL = have_x86_feat(t, .sse4_1) and t.os.tag != .windows,
        .HAVE_SSE42_EXTERNAL = have_x86_feat(t, .sse4_2) and t.os.tag != .windows,
        .HAVE_SSSE3_EXTERNAL = have_x86_feat(t, .ssse3) and t.os.tag != .windows,
        .HAVE_XOP_EXTERNAL = have_x86_feat(t, .xop) and t.os.tag != .windows,
        .HAVE_I686_EXTERNAL = have_x86_feat(t, .cmov) and
            have_x86_feat(t, .cx8) and
            have_x86_feat(t, .vzeroupper) and
            have_x86_feat(t, .x87) and t.os.tag != .windows,
        ...
        // Disable x86 inline ASM on Windows: FFmpeg's inline ASM assumes the
        // System V x86-64 ABI where all XMM registers are caller-saved.  On
        // Windows x64, XMM6-15 are callee-saved — the inline ASM clobbers them
        // without saving, corrupting the caller's register state.  This causes
        // pink tint / horizontal stripe artifacts in libswscale output.
        .HAVE_AESNI_INLINE = have_x86_feat(t, .aes) and t.os.tag != .windows,
        .HAVE_AMD3DNOW_INLINE = false,
        .HAVE_AMD3DNOWEXT_INLINE = false,
        .HAVE_AVX_INLINE = have_x86_feat(t, .avx) and t.os.tag != .windows,
        .HAVE_AVX2_INLINE = have_x86_feat(t, .avx2) and t.os.tag != .windows,
        .HAVE_AVX512_INLINE = have_x86_feat(t, .avx512f) and t.os.tag != .windows,
        .HAVE_AVX512ICL_INLINE = have_x86_feat(t, .avx512f) and t.os.tag != .windows,
        .HAVE_FMA3_INLINE = have_x86_feat(t, .fma) and t.os.tag != .windows,
        .HAVE_FMA4_INLINE = have_x86_feat(t, .fma4) and t.os.tag != .windows,
        .HAVE_MMX_INLINE = have_x86_feat(t, .mmx) and t.os.tag != .windows,
        .HAVE_MMXEXT_INLINE = have_x86_feat(t, .mmx) and t.os.tag != .windows,
        .HAVE_SSE_INLINE = have_x86_feat(t, .sse) and t.os.tag != .windows,
        .HAVE_SSE2_INLINE = have_x86_feat(t, .sse2) and t.os.tag != .windows,
        .HAVE_SSE3_INLINE = have_x86_feat(t, .sse3) and t.os.tag != .windows,
        .HAVE_SSE4_INLINE = have_x86_feat(t, .sse4_1) and t.os.tag != .windows,
        .HAVE_SSE42_INLINE = have_x86_feat(t, .sse4_2) and t.os.tag != .windows,
        .HAVE_SSSE3_INLINE = have_x86_feat(t, .ssse3) and t.os.tag != .windows,
        .HAVE_XOP_INLINE = have_x86_feat(t, .xop) and t.os.tag != .windows,
        ...
        .HAVE_INLINE_ASM = t.os.tag != .windows,
        .HAVE_SYMVER = true,
        ...
        .HAVE_ASM_TYPES_H = t.os.tag == .linux,
        ...
        .HAVE_GETOPT = t.os.tag != .windows,
        .HAVE_GETMODULEHANDLE = t.os.tag == .windows,
        .HAVE_GETPROCESSAFFINITYMASK = t.os.tag == .windows,
        .HAVE_GETPROCESSMEMORYINFO = t.os.tag == .windows,
        .HAVE_GETPROCESSTIMES = t.os.tag == .windows,
        .HAVE_GETRUSAGE = t.os.tag != .windows,
        .HAVE_GETSTDHANDLE = t.os.tag == .windows,
        .HAVE_GETSYSTEMTIMEASFILETIME = t.os.tag == .windows,
        .HAVE_GETTIMEOFDAY = t.os.tag != .windows,
        .HAVE_GLOB = t.os.tag != .windows,
        .HAVE_GLXGETPROCADDRESS = false,
        .HAVE_GMTIME_R = t.os.tag != .windows,
        .HAVE_INET_ATON = t.os.tag != .windows,
        .HAVE_ISATTY = true,
        .HAVE_KBHIT = t.os.tag == .windows,
        .HAVE_LOCALTIME_R = t.os.tag != .windows,
        .HAVE_LSTAT = t.os.tag != .windows,
        .HAVE_LZO1X_999_COMPRESS = false,
        .HAVE_MACH_ABSOLUTE_TIME = t.os.tag == .macos,
        ...
        .HAVE_PTHREAD_CANCEL = t.os.tag != .windows,
        .HAVE_PTHREAD_SET_NAME_NP = false,
        .HAVE_PTHREAD_SETNAME_NP = false,
        .HAVE_SCHED_GETAFFINITY = t.os.tag == .linux,
        .HAVE_SECITEMIMPORT = t.os.tag == .macos,
        .HAVE_SETCONSOLETEXTATTRIBUTE = t.os.tag == .windows,
        .HAVE_SETCONSOLECTRLHANDLER = t.os.tag == .windows,
        .HAVE_SETDLLDIRECTORY = t.os.tag == .windows,
        .HAVE_SETMODE = t.os.tag == .windows,
        .HAVE_SETRLIMIT = t.os.tag != .windows,
        ...
        .HAVE_IBM_ASM = false,
        .HAVE_INLINE_ASM_DIRECT_SYMBOL_REFS = t.os.tag != .windows,
        .HAVE_INLINE_ASM_LABELS = t.os.tag != .windows,
        .HAVE_INLINE_ASM_NONLOCAL_LABELS = t.os.tag != .windows,
    ...
    // Compile avdevice on Linux (ALSA disabled — libasound2-dev not required)
    if (t.os.tag == .linux) {
        lib.root_module.addCSourceFiles(.{
            .files = &.{
            ...
            .flags = ffmpeg_cflags ++ [_][]const u8{"-DBUILDING_avdevice"},
        });
    }
    ...
    switch (t.cpu.arch) {
        .x86_64, .x86 => {
            ...
            // Skip on Windows: the nasm package fails to build there (missing
            // POSIX endian.h) and the -f elf64 output format is Linux-only.
            // FFmpeg's C fallbacks are used instead — correct but slightly slower.
            if (t.os.tag != .windows) {
...
fn categorizeSources(ally: std.mem.Allocator, target: std.Target, tls: Tls) CategorizedSources {
    ...
    for (all_sources) |prefixed_path| {
        ...
        // Skip files that require missing dependencies or disabled hardware-accel configs.
        if (std.mem.startsWith(u8, sub_path, "d3d12va_") or
            std.mem.eql(u8, sub_path, "d3d11va.c") or
            std.mem.eql(u8, sub_path, "macos_kperf.c") or
            std.mem.eql(u8, sub_path, "mfenc.c") or
            std.mem.eql(u8, sub_path, "mf_utils.c") or
            (std.mem.eql(u8, sub_path, "unix.c") and target.os.tag == .windows) or
            std.mem.eql(u8, sub_path, "vsrc_ddagrab.c")) continue;
