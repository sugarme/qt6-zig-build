...
namespace {
struct qt_meta_tag_ZN16QAccessibleCacheE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN16QAccessibleCacheE = QtMocHelpers::stringData(
    "QAccessibleCache",
    "objectDestroyed",
    "",
    "obj"
...
Q_CONSTINIT static const uint qt_meta_data_ZN16QAccessibleCacheE[] = {
...
Q_CONSTINIT const QMetaObject QAccessibleCache::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN16QAccessibleCacheE.offsetsAndSizes,
    qt_meta_data_ZN16QAccessibleCacheE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN16QAccessibleCacheE_t,
        // Q_OBJECT / Q_GADGET
...
void *QAccessibleCache::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN16QAccessibleCacheE.stringdata0))
