...
static constexpr auto qt_meta_stringdata_ZN5QDragE = QtMocHelpers::stringData(
    "QDrag",
    "actionChanged",
    "",
    "Qt::DropAction",
...
Q_CONSTINIT static const uint qt_meta_data_ZN5QDragE[] = {
...
Q_CONSTINIT const QMetaObject QDrag::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN5QDragE.offsetsAndSizes,
    qt_meta_data_ZN5QDragE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN5QDragE_t,
        // Q_OBJECT / Q_GADGET
...
void QDrag::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (QDrag::*)(Qt::DropAction );
            if (_q_method_type _q_method = &QDrag::actionChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _q_method_type = void (QDrag::*)(QObject * );
            if (_q_method_type _q_method = &QDrag::targetChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
void *QDrag::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN5QDragE.stringdata0))
