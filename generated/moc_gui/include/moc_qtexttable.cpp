...
namespace {
struct qt_meta_tag_ZN10QTextTableE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN10QTextTableE = QtMocHelpers::stringData(
    "QTextTable"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN10QTextTableE[] = {
...
Q_CONSTINIT const QMetaObject QTextTable::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN10QTextTableE.offsetsAndSizes,
    qt_meta_data_ZN10QTextTableE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN10QTextTableE_t,
        // Q_OBJECT / Q_GADGET
...
void QTextTable::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    auto *_t = static_cast<QTextTable *>(_o);
    (void)_t;
    (void)_c;
    (void)_id;
    (void)_a;
...
void *QTextTable::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN10QTextTableE.stringdata0))
