...
static constexpr auto qt_meta_stringdata_ZN10QPdfWriterE = QtMocHelpers::stringData(
    "QPdfWriter",
    "ColorModel",
    "RGB",
    "Grayscale",
...
Q_CONSTINIT static const uint qt_meta_data_ZN10QPdfWriterE[] = {
...
Q_CONSTINIT const QMetaObject QPdfWriter::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN10QPdfWriterE.offsetsAndSizes,
    qt_meta_data_ZN10QPdfWriterE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN10QPdfWriterE_t,
        // enum 'ColorModel'
...
void *QPdfWriter::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN10QPdfWriterE.stringdata0))
