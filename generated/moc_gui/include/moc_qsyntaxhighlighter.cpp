...
static constexpr auto qt_meta_stringdata_ZN18QSyntaxHighlighterE = QtMocHelpers::stringData(
    "QSyntaxHighlighter",
    "rehighlight",
    "",
    "rehighlightBlock",
...
Q_CONSTINIT static const uint qt_meta_data_ZN18QSyntaxHighlighterE[] = {
...
Q_CONSTINIT const QMetaObject QSyntaxHighlighter::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN18QSyntaxHighlighterE.offsetsAndSizes,
    qt_meta_data_ZN18QSyntaxHighlighterE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN18QSyntaxHighlighterE_t,
        // Q_OBJECT / Q_GADGET
...
void *QSyntaxHighlighter::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN18QSyntaxHighlighterE.stringdata0))
