...
static constexpr auto qt_meta_stringdata_ZN9QSaveFileE = QtMocHelpers::stringData(
    "QSaveFile"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN9QSaveFileE[] = {
...
Q_CONSTINIT const QMetaObject QSaveFile::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN9QSaveFileE.offsetsAndSizes,
    qt_meta_data_ZN9QSaveFileE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN9QSaveFileE_t,
        // Q_OBJECT / Q_GADGET
...
void *QSaveFile::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN9QSaveFileE.stringdata0))
