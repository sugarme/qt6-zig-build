...
static constexpr auto qt_meta_stringdata_ZN13QSignalMapperE = QtMocHelpers::stringData(
    "QSignalMapper",
    "mappedInt",
    "",
    "mappedString",
...
Q_CONSTINIT static const uint qt_meta_data_ZN13QSignalMapperE[] = {
...
Q_CONSTINIT const QMetaObject QSignalMapper::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN13QSignalMapperE.offsetsAndSizes,
    qt_meta_data_ZN13QSignalMapperE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN13QSignalMapperE_t,
        // Q_OBJECT / Q_GADGET
...
void QSignalMapper::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (QSignalMapper::*)(int );
            if (_q_method_type _q_method = &QSignalMapper::mappedInt; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _q_method_type = void (QSignalMapper::*)(const QString & );
            if (_q_method_type _q_method = &QSignalMapper::mappedString; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            using _q_method_type = void (QSignalMapper::*)(QObject * );
            if (_q_method_type _q_method = &QSignalMapper::mappedObject; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
...
void *QSignalMapper::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN13QSignalMapperE.stringdata0))
