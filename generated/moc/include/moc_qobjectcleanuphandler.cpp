...
namespace {
struct qt_meta_tag_ZN21QObjectCleanupHandlerE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN21QObjectCleanupHandlerE = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_ZN21QObjectCleanupHandlerE[] = {
...
Q_CONSTINIT const QMetaObject QObjectCleanupHandler::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN21QObjectCleanupHandlerE.offsetsAndSizes,
    qt_meta_data_ZN21QObjectCleanupHandlerE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN21QObjectCleanupHandlerE_t,
        // Q_OBJECT / Q_GADGET
...
void *QObjectCleanupHandler::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN21QObjectCleanupHandlerE.stringdata0))
