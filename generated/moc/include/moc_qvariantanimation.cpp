...
static constexpr auto qt_meta_stringdata_ZN17QVariantAnimationE = QtMocHelpers::stringData(
    "QVariantAnimation",
    "valueChanged",
    "",
    "QVariant",
...
Q_CONSTINIT static const uint qt_meta_data_ZN17QVariantAnimationE[] = {
...
Q_CONSTINIT const QMetaObject QVariantAnimation::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN17QVariantAnimationE.offsetsAndSizes,
    qt_meta_data_ZN17QVariantAnimationE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN17QVariantAnimationE_t,
        // property 'startValue'
...
void QVariantAnimation::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (QVariantAnimation::*)(const QVariant & );
            if (_q_method_type _q_method = &QVariantAnimation::valueChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *QVariantAnimation::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN17QVariantAnimationE.stringdata0))
