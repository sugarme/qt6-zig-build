...
static constexpr auto qt_meta_stringdata_ZN15QPauseAnimationE = QtMocHelpers::stringData(
    "QPauseAnimation",
    "duration"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN15QPauseAnimationE[] = {
...
Q_CONSTINIT const QMetaObject QPauseAnimation::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN15QPauseAnimationE.offsetsAndSizes,
    qt_meta_data_ZN15QPauseAnimationE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN15QPauseAnimationE_t,
        // property 'duration'
...
void *QPauseAnimation::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN15QPauseAnimationE.stringdata0))
