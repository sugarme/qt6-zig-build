...
namespace {
struct qt_meta_tag_ZN24QFileSystemWatcherEngineE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN24QFileSystemWatcherEngineE = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_ZN24QFileSystemWatcherEngineE[] = {
...
Q_CONSTINIT const QMetaObject QFileSystemWatcherEngine::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN24QFileSystemWatcherEngineE.offsetsAndSizes,
    qt_meta_data_ZN24QFileSystemWatcherEngineE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN24QFileSystemWatcherEngineE_t,
        // Q_OBJECT / Q_GADGET
...
void QFileSystemWatcherEngine::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (QFileSystemWatcherEngine::*)(const QString & , bool );
            if (_q_method_type _q_method = &QFileSystemWatcherEngine::fileChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _q_method_type = void (QFileSystemWatcherEngine::*)(const QString & , bool );
            if (_q_method_type _q_method = &QFileSystemWatcherEngine::directoryChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
void *QFileSystemWatcherEngine::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN24QFileSystemWatcherEngineE.stringdata0))
