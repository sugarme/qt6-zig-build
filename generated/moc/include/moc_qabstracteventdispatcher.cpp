...
static constexpr auto qt_meta_stringdata_ZN24QAbstractEventDispatcherE = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_ZN24QAbstractEventDispatcherE[] = {
...
Q_CONSTINIT const QMetaObject QAbstractEventDispatcher::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN24QAbstractEventDispatcherE.offsetsAndSizes,
    qt_meta_data_ZN24QAbstractEventDispatcherE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN24QAbstractEventDispatcherE_t,
        // Q_OBJECT / Q_GADGET
...
void QAbstractEventDispatcher::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (QAbstractEventDispatcher::*)();
            if (_q_method_type _q_method = &QAbstractEventDispatcher::aboutToBlock; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _q_method_type = void (QAbstractEventDispatcher::*)();
            if (_q_method_type _q_method = &QAbstractEventDispatcher::awake; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
void *QAbstractEventDispatcher::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN24QAbstractEventDispatcherE.stringdata0))
...
#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN26QAbstractEventDispatcherV2E = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_ZN26QAbstractEventDispatcherV2E[] = {
...
Q_CONSTINIT const QMetaObject QAbstractEventDispatcherV2::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN26QAbstractEventDispatcherV2E.offsetsAndSizes,
    qt_meta_data_ZN26QAbstractEventDispatcherV2E,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN26QAbstractEventDispatcherV2E_t,
        // Q_OBJECT / Q_GADGET
...
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_ZN26QAbstractEventDispatcherV2E.stringdata0))
        return static_cast<void*>(this);
