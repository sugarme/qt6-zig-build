...
static constexpr auto qt_meta_stringdata_ZN15QSocketNotifierE = QtMocHelpers::stringData(
    "QSocketNotifier",
    "activated",
    "",
    "QSocketDescriptor",
...
Q_CONSTINIT static const uint qt_meta_data_ZN15QSocketNotifierE[] = {
...
Q_CONSTINIT const QMetaObject QSocketNotifier::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN15QSocketNotifierE.offsetsAndSizes,
    qt_meta_data_ZN15QSocketNotifierE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN15QSocketNotifierE_t,
        // Q_OBJECT / Q_GADGET
...
void QSocketNotifier::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (QSocketNotifier::*)(QSocketDescriptor , QSocketNotifier::Type , QPrivateSignal);
            if (_q_method_type _q_method = &QSocketNotifier::activated; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _q_method_type = void (QSocketNotifier::*)(int , QPrivateSignal);
            if (_q_method_type _q_method = &QSocketNotifier::activated; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
...
void *QSocketNotifier::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN15QSocketNotifierE.stringdata0))
