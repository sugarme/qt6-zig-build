...
static constexpr auto qt_meta_stringdata_ZN18QFileSystemWatcherE = QtMocHelpers::stringData(
    "QFileSystemWatcher",
    "fileChanged",
    "",
    "path",
...
Q_CONSTINIT static const uint qt_meta_data_ZN18QFileSystemWatcherE[] = {
...
Q_CONSTINIT const QMetaObject QFileSystemWatcher::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN18QFileSystemWatcherE.offsetsAndSizes,
    qt_meta_data_ZN18QFileSystemWatcherE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN18QFileSystemWatcherE_t,
        // Q_OBJECT / Q_GADGET
...
void QFileSystemWatcher::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (QFileSystemWatcher::*)(const QString & , QPrivateSignal);
            if (_q_method_type _q_method = &QFileSystemWatcher::fileChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _q_method_type = void (QFileSystemWatcher::*)(const QString & , QPrivateSignal);
            if (_q_method_type _q_method = &QFileSystemWatcher::directoryChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
void *QFileSystemWatcher::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN18QFileSystemWatcherE.stringdata0))
