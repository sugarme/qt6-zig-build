...
static constexpr auto qt_meta_stringdata_ZN15QAnimationGroupE = QtMocHelpers::stringData(
    "QAnimationGroup"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN15QAnimationGroupE[] = {
...
Q_CONSTINIT const QMetaObject QAnimationGroup::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN15QAnimationGroupE.offsetsAndSizes,
    qt_meta_data_ZN15QAnimationGroupE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN15QAnimationGroupE_t,
        // Q_OBJECT / Q_GADGET
...
void *QAnimationGroup::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN15QAnimationGroupE.stringdata0))
