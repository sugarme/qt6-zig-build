...
namespace {
struct qt_meta_tag_ZN19QNativeSocketEngineE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN19QNativeSocketEngineE = QtMocHelpers::stringData(
    "QNativeSocketEngine",
...
Q_CONSTINIT static const uint qt_meta_data_ZN19QNativeSocketEngineE[] = {
...
Q_CONSTINIT const QMetaObject QNativeSocketEngine::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN19QNativeSocketEngineE.offsetsAndSizes,
    qt_meta_data_ZN19QNativeSocketEngineE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN19QNativeSocketEngineE_t,
        // Q_OBJECT / Q_GADGET
...
void *QNativeSocketEngine::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN19QNativeSocketEngineE.stringdata0))
