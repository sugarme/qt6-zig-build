...
namespace {
struct qt_meta_tag_ZN18QDnsLookupRunnableE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN18QDnsLookupRunnableE = QtMocHelpers::stringData(
    "QDnsLookupRunnable",
    "finished",
    "",
    "QDnsLookupReply",
...
Q_CONSTINIT static const uint qt_meta_data_ZN18QDnsLookupRunnableE[] = {
...
Q_CONSTINIT const QMetaObject QDnsLookupRunnable::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN18QDnsLookupRunnableE.offsetsAndSizes,
    qt_meta_data_ZN18QDnsLookupRunnableE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN18QDnsLookupRunnableE_t,
        // Q_OBJECT / Q_GADGET
...
void QDnsLookupRunnable::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (QDnsLookupRunnable::*)(const QDnsLookupReply & );
            if (_q_method_type _q_method = &QDnsLookupRunnable::finished; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *QDnsLookupRunnable::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN18QDnsLookupRunnableE.stringdata0))
