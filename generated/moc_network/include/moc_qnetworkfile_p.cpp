...
static constexpr auto qt_meta_stringdata_ZN12QNetworkFileE = QtMocHelpers::stringData(
    "QNetworkFile",
    "finished",
    "",
    "ok",
...
Q_CONSTINIT static const uint qt_meta_data_ZN12QNetworkFileE[] = {
...
Q_CONSTINIT const QMetaObject QNetworkFile::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN12QNetworkFileE.offsetsAndSizes,
    qt_meta_data_ZN12QNetworkFileE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN12QNetworkFileE_t,
        // Q_OBJECT / Q_GADGET
...
void QNetworkFile::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (QNetworkFile::*)(bool );
            if (_q_method_type _q_method = &QNetworkFile::finished; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _q_method_type = void (QNetworkFile::*)(QHttpHeaders::WellKnownHeader , const QByteArray & );
            if (_q_method_type _q_method = &QNetworkFile::headerRead; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            using _q_method_type = void (QNetworkFile::*)(QNetworkReply::NetworkError , const QString & );
            if (_q_method_type _q_method = &QNetworkFile::networkError; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
...
void *QNetworkFile::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN12QNetworkFileE.stringdata0))
