...
static constexpr auto qt_meta_stringdata_ZN21QAbstractNetworkCacheE = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_ZN21QAbstractNetworkCacheE[] = {
...
Q_CONSTINIT const QMetaObject QAbstractNetworkCache::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN21QAbstractNetworkCacheE.offsetsAndSizes,
    qt_meta_data_ZN21QAbstractNetworkCacheE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN21QAbstractNetworkCacheE_t,
        // Q_OBJECT / Q_GADGET
...
void *QAbstractNetworkCache::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN21QAbstractNetworkCacheE.stringdata0))
