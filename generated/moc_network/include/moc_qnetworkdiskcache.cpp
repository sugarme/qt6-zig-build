...
static constexpr auto qt_meta_stringdata_ZN17QNetworkDiskCacheE = QtMocHelpers::stringData(
    "QNetworkDiskCache",
    "clear",
    ""
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN17QNetworkDiskCacheE[] = {
...
Q_CONSTINIT const QMetaObject QNetworkDiskCache::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN17QNetworkDiskCacheE.offsetsAndSizes,
    qt_meta_data_ZN17QNetworkDiskCacheE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN17QNetworkDiskCacheE_t,
        // Q_OBJECT / Q_GADGET
...
void *QNetworkDiskCache::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN17QNetworkDiskCacheE.stringdata0))
