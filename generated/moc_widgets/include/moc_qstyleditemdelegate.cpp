...
static constexpr auto qt_meta_stringdata_ZN19QStyledItemDelegateE = QtMocHelpers::stringData(
    "QStyledItemDelegate"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN19QStyledItemDelegateE[] = {
...
Q_CONSTINIT const QMetaObject QStyledItemDelegate::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN19QStyledItemDelegateE.offsetsAndSizes,
    qt_meta_data_ZN19QStyledItemDelegateE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN19QStyledItemDelegateE_t,
        // Q_OBJECT / Q_GADGET
...
void *QStyledItemDelegate::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN19QStyledItemDelegateE.stringdata0))
