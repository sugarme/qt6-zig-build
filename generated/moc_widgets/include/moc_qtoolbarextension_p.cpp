...
namespace {
struct qt_meta_tag_ZN17QToolBarExtensionE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN17QToolBarExtensionE = QtMocHelpers::stringData(
    "QToolBarExtension",
    "setOrientation",
    "",
    "Qt::Orientation",
...
Q_CONSTINIT static const uint qt_meta_data_ZN17QToolBarExtensionE[] = {
...
Q_CONSTINIT const QMetaObject QToolBarExtension::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN17QToolBarExtensionE.offsetsAndSizes,
    qt_meta_data_ZN17QToolBarExtensionE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN17QToolBarExtensionE_t,
        // Q_OBJECT / Q_GADGET
...
void *QToolBarExtension::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN17QToolBarExtensionE.stringdata0))
