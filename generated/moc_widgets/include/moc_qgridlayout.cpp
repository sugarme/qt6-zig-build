...
static constexpr auto qt_meta_stringdata_ZN11QGridLayoutE = QtMocHelpers::stringData(
    "QGridLayout"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN11QGridLayoutE[] = {
...
Q_CONSTINIT const QMetaObject QGridLayout::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN11QGridLayoutE.offsetsAndSizes,
    qt_meta_data_ZN11QGridLayoutE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN11QGridLayoutE_t,
        // Q_OBJECT / Q_GADGET
...
void *QGridLayout::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN11QGridLayoutE.stringdata0))
