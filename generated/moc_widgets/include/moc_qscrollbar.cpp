...
static constexpr auto qt_meta_stringdata_ZN10QScrollBarE = QtMocHelpers::stringData(
    "QScrollBar"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN10QScrollBarE[] = {
...
Q_CONSTINIT const QMetaObject QScrollBar::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN10QScrollBarE.offsetsAndSizes,
    qt_meta_data_ZN10QScrollBarE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN10QScrollBarE_t,
        // Q_OBJECT / Q_GADGET
...
void *QScrollBar::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN10QScrollBarE.stringdata0))
