...
static constexpr auto qt_meta_stringdata_ZN11QColumnViewE = QtMocHelpers::stringData(
    "QColumnView",
    "updatePreviewWidget",
    "",
    "QModelIndex",
...
Q_CONSTINIT static const uint qt_meta_data_ZN11QColumnViewE[] = {
...
Q_CONSTINIT const QMetaObject QColumnView::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN11QColumnViewE.offsetsAndSizes,
    qt_meta_data_ZN11QColumnViewE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN11QColumnViewE_t,
...
void QColumnView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (QColumnView::*)(const QModelIndex & );
            if (_q_method_type _q_method = &QColumnView::updatePreviewWidget; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *QColumnView::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN11QColumnViewE.stringdata0))
