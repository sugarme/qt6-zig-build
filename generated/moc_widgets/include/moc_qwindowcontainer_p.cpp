...
namespace {
struct qt_meta_tag_ZN16QWindowContainerE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN16QWindowContainerE = QtMocHelpers::stringData(
    "QWindowContainer"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN16QWindowContainerE[] = {
...
Q_CONSTINIT const QMetaObject QWindowContainer::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN16QWindowContainerE.offsetsAndSizes,
    qt_meta_data_ZN16QWindowContainerE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN16QWindowContainerE_t,
        // Q_OBJECT / Q_GADGET
...
void *QWindowContainer::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN16QWindowContainerE.stringdata0))
