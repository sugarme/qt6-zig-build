...
static constexpr auto qt_meta_stringdata_ZN12QRadioButtonE = QtMocHelpers::stringData(
    "QRadioButton"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN12QRadioButtonE[] = {
...
Q_CONSTINIT const QMetaObject QRadioButton::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN12QRadioButtonE.offsetsAndSizes,
    qt_meta_data_ZN12QRadioButtonE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN12QRadioButtonE_t,
        // Q_OBJECT / Q_GADGET
...
void *QRadioButton::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN12QRadioButtonE.stringdata0))
