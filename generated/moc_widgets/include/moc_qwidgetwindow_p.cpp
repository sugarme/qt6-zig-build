...
namespace {
struct qt_meta_tag_ZN13QWidgetWindowE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN13QWidgetWindowE = QtMocHelpers::stringData(
    "QWidgetWindow",
    "updateObjectName",
    ""
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN13QWidgetWindowE[] = {
...
Q_CONSTINIT const QMetaObject QWidgetWindow::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN13QWidgetWindowE.offsetsAndSizes,
    qt_meta_data_ZN13QWidgetWindowE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN13QWidgetWindowE_t,
        // Q_OBJECT / Q_GADGET
...
void *QWidgetWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN13QWidgetWindowE.stringdata0))
