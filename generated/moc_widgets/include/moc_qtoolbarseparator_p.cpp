...
namespace {
struct qt_meta_tag_ZN17QToolBarSeparatorE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN17QToolBarSeparatorE = QtMocHelpers::stringData(
    "QToolBarSeparator",
    "setOrientation",
    "",
    "Qt::Orientation",
...
Q_CONSTINIT static const uint qt_meta_data_ZN17QToolBarSeparatorE[] = {
...
Q_CONSTINIT const QMetaObject QToolBarSeparator::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN17QToolBarSeparatorE.offsetsAndSizes,
    qt_meta_data_ZN17QToolBarSeparatorE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN17QToolBarSeparatorE_t,
        // Q_OBJECT / Q_GADGET
...
void *QToolBarSeparator::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN17QToolBarSeparatorE.stringdata0))
