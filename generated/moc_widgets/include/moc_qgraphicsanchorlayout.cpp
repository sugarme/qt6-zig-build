...
static constexpr auto qt_meta_stringdata_ZN15QGraphicsAnchorE = QtMocHelpers::stringData(
    "QGraphicsAnchor",
    "spacing",
    "sizePolicy",
    "QSizePolicy::Policy"
...
Q_CONSTINIT static const uint qt_meta_data_ZN15QGraphicsAnchorE[] = {
...
Q_CONSTINIT const QMetaObject QGraphicsAnchor::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN15QGraphicsAnchorE.offsetsAndSizes,
    qt_meta_data_ZN15QGraphicsAnchorE,
    qt_static_metacall,
    qt_meta_extradata_ZN15QGraphicsAnchorE,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN15QGraphicsAnchorE_t,
        // property 'spacing'
...
void *QGraphicsAnchor::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN15QGraphicsAnchorE.stringdata0))
