...
namespace {
struct qt_meta_tag_ZN13QWindowsStyleE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN13QWindowsStyleE = QtMocHelpers::stringData(
    "QWindowsStyle"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN13QWindowsStyleE[] = {
...
Q_CONSTINIT const QMetaObject QWindowsStyle::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN13QWindowsStyleE.offsetsAndSizes,
    qt_meta_data_ZN13QWindowsStyleE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN13QWindowsStyleE_t,
        // Q_OBJECT / Q_GADGET
...
void QWindowsStyle::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    auto *_t = static_cast<QWindowsStyle *>(_o);
    (void)_t;
    (void)_c;
    (void)_id;
    (void)_a;
...
void *QWindowsStyle::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN13QWindowsStyleE.stringdata0))
