...
static constexpr auto qt_meta_stringdata_ZN14QStackedLayoutE = QtMocHelpers::stringData(
    "QStackedLayout",
    "widgetRemoved",
    "",
    "index",
...
Q_CONSTINIT static const uint qt_meta_data_ZN14QStackedLayoutE[] = {
...
Q_CONSTINIT const QMetaObject QStackedLayout::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN14QStackedLayoutE.offsetsAndSizes,
    qt_meta_data_ZN14QStackedLayoutE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN14QStackedLayoutE_t,
...
void QStackedLayout::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (QStackedLayout::*)(int );
            if (_q_method_type _q_method = &QStackedLayout::widgetRemoved; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _q_method_type = void (QStackedLayout::*)(int );
            if (_q_method_type _q_method = &QStackedLayout::currentChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
void *QStackedLayout::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN14QStackedLayoutE.stringdata0))
