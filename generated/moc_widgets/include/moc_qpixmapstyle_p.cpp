...
namespace {
struct qt_meta_tag_ZN12QPixmapStyleE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN12QPixmapStyleE = QtMocHelpers::stringData(
    "QPixmapStyle"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN12QPixmapStyleE[] = {
...
Q_CONSTINIT const QMetaObject QPixmapStyle::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN12QPixmapStyleE.offsetsAndSizes,
    qt_meta_data_ZN12QPixmapStyleE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN12QPixmapStyleE_t,
        // Q_OBJECT / Q_GADGET
...
void QPixmapStyle::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    auto *_t = static_cast<QPixmapStyle *>(_o);
    (void)_t;
    (void)_c;
    (void)_id;
    (void)_a;
...
void *QPixmapStyle::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN12QPixmapStyleE.stringdata0))
