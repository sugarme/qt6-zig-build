...
namespace {
struct qt_meta_tag_ZN8QToolBoxE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN8QToolBoxE = QtMocHelpers::stringData(
    "QToolBox",
    "currentChanged",
    "",
    "index",
...
Q_CONSTINIT static const uint qt_meta_data_ZN8QToolBoxE[] = {
...
Q_CONSTINIT const QMetaObject QToolBox::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN8QToolBoxE.offsetsAndSizes,
    qt_meta_data_ZN8QToolBoxE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN8QToolBoxE_t,
...
void QToolBox::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (QToolBox::*)(int );
            if (_q_method_type _q_method = &QToolBox::currentChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *QToolBox::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN8QToolBoxE.stringdata0))
